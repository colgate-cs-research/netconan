...
def _parse_args(argv):
    ...
    parser.add_argument('-b', '--line-beginnings', default=None,
                        help='List of comma separated line beginnings for lines that should be removed')
...
def main(argv=sys.argv[1:]):
    ...
    if args.line_beginnings is not None:
        line_beginnings = args.line_beginnings.split(',')
    ...
    if not any([
        ...
        anonymize_files(args.input, args.output, args.anonymize_passwords,
                        ...
                        preserve_prefixes, preserve_addresses, line_beginnings)
